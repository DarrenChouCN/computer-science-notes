...
Figure 7-2 illustrates the relationship between the perceived intensity of conflicts and the conflict resolution modes used by project managers. The figure highlights which resolution styles are strongly favorable (associated with low conflict) or unfavorable (associated with high conflict) in different scenarios. For example, forcing and withdrawal are often unfavorable when resolving conflicts between project managers and their personnel or superiors. In contrast, compromise and smoothing are generally favorable in these contexts. The figure emphasizes that the choice of resolution mode depends on the specific relationship (e.g., with personnel, superiors, or functional departments) and its impact on conflict intensity.

Figure 7-3 shows the relationship between the influence methods used by project managers and the perceived intensity of conflicts. Influence methods such as work challenge, friendship, and promotions are strongly favorable, as they are associated with lower conflict intensity. Conversely, expertise, authority, and penalty power are often unfavorable, as they tend to increase conflict intensity. The figure demonstrates that the effectiveness of influence methods varies depending on the relationship (e.g., with personnel, superiors, or functional departments), highlighting the importance of choosing the right approach to minimize conflicts.
